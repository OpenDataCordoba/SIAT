...
/**
 * Clase Auxiliar para la Generacion del Reporte de Distribucion de Totales Emitidos
 * 
 * @author Tecso
 *
 */
public class AuxDistribucionReport extends Common {
