...
public class SelAlmContr extends SelAlm {
	...
	// Metodos de Clase
	public static SelAlmContr getById(Long id) {
		return (SelAlmContr) GdeDAOFactory.getSelAlmDeudaDAO().getById(id);  
	}
	
	public static SelAlmContr getByIdNull(Long id) {
		return (SelAlmContr) GdeDAOFactory.getSelAlmDAO().getByIdNull(id);
	}
