...
/**
 * Adapter del Proceso de Impresion Mensual de CdM
 * 
 * @author tecso
 */
public class ProcesoImpresionCdMAdapter extends SiatAdapterModel{
	
	private static final long serialVersionUID = 1L;
	
	public static final String NAME = "procesoImpresionCdMAdapterVO";
	public static final String ENC_NAME = "impresionCdMAdapterVO";
	
    private EmisionVO emision = new EmisionVO();

    private ObraVO obra = new ObraVO();
	 
    // La corrida de impresion tiene dos pasos
    // 1: generar los reportes
    private PasoCorridaVO pasoCorrida1 = new PasoCorridaVO();
	// 2: marcar la deuda como impresa
	...
	// Constructores
	public ProcesoImpresionCdMAdapter(){
