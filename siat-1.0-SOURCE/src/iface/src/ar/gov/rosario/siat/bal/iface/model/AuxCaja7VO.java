...
/**
 * Value Object del AuxCaja7
 * @author tecso
 *
 */
public class AuxCaja7VO extends SiatBussImageModel {

	
	private static final long serialVersionUID = 1L;

	public static final String NAME = "auxCaja7VO";
	...
	public AuxCaja7VO(int id, String desc) {
		super();
		setId(new Long(id));
