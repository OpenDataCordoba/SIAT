...
public class TranBalVO extends SiatBussImageModel {
	...
	public void setIdTranAfip(Long idTranAfip) {
		...
		this.idTranAfipView = StringUtil.formatLong(idTranAfip);
	}

	public String getIdTranAfipView() {
		return idTranAfipView;
	}
