...
/**
 * Adapter del Proceso de Generacion de  
 * Archivos PAS y Debito
 * 
 * @author tecso
 */
public class ProcesoProPasDebAdapter extends SiatAdapterModel{
	
	private static final long serialVersionUID = 1L;
	
	public static final String NAME = "procesoProPasDebAdapterVO";
	...
	// Constructores
    public ProcesoProPasDebAdapter(){
