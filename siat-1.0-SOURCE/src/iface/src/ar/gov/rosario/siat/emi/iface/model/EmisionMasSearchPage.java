 ...
 *
 */
public class EmisionMasSearchPage extends SiatPageModel {

	private static final long serialVersionUID = 1L;

	public static final String NAME = "emisionMasSearchPageVO";
	...
	public String getAdministrarProcesoEnabled() {
		return SiatBussImageModel.hasEnabledFlag
			(EmiSecurityConstants.ABM_EMISIONMAS, EmiSecurityConstants.ACT_ADMINISTRAR_PROCESO);
	}
