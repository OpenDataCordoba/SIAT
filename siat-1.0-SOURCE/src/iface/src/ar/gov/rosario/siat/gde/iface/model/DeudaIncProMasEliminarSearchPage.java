...
/**
 * Search Page de Seleccion de eliminacion de Deudas a agregar del Proceso de Envio Judicial 
 * @author tecso
 *
 */
public class DeudaIncProMasEliminarSearchPage extends SiatPageModel {

	private static final long serialVersionUID = 1L;

	public static final String NAME = "deudaIncProMasEliminarSearchPageVO";
	public static final String FILE_NAME = "deudaIncProMasEliminar";
	...
	private Boolean eliminarSeleccionIndividualBussEnabled = Boolean.TRUE;
		
	public DeudaIncProMasEliminarSearchPage(){
	...
	public Boolean getEliminarSeleccionIndividualBussEnabled() {
		return eliminarSeleccionIndividualBussEnabled;
	}
	public void setEliminarSeleccionIndividualBussEnabled(
			Boolean eliminarSeleccionIndividualBussEnabled) {
		this.eliminarSeleccionIndividualBussEnabled = eliminarSeleccionIndividualBussEnabled;
	}
	...
	public String getCtdTotalResultadosView(){
		return StringUtil.formatLong(getCtdTotalResultados());
	}
