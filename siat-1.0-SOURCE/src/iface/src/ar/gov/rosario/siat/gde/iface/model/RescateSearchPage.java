 ...
 *
 */
public class RescateSearchPage extends SiatPageModel {

	private static final long serialVersionUID = 1L;

	public static final String NAME = "rescateSearchPageVO";
	...
	public String getAdmSeleccionEnabled() {
		return SiatBussImageModel.hasEnabledFlag(this.getAdmSeleccionBussEnabled(),
				GdeSecurityConstants.ABM_RESCATE,	GdeSecurityConstants.MTD_ADM_SELECCION);
	}
	public String getAdmProcesoEnabled() {
		return SiatBussImageModel.hasEnabledFlag(this.getAdmProcesoBussEnabled(),
				GdeSecurityConstants.ABM_RESCATE,	GdeSecurityConstants.MTD_ADM_PROCESO);
	}
