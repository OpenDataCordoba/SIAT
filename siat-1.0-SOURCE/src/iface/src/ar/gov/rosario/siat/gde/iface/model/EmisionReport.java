 ...
 *
 */
public class EmisionReport extends SiatPageModel{
	
	private static final long serialVersionUID = 1L;

	public static final String NAME = "emisionReportVO";
	...
	//	 Constructores
	public EmisionReport() {
		super(GdeSecurityConstants.EMISION_REPORT);
	}
