...
/**
 * SearchPage del AuxDeuda
 * 
 * @author Tecso
 *
 */
public class AuxDeudaSearchPage extends SiatPageModel {

	private static final long serialVersionUID = 1L;

	public static final String NAME = "auxDeudaSearchPageVO";
