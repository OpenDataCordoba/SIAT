...
/**
 * Adapter del Proceso de Emision Corregida de CdM
 * 
 * @author tecso
 */
public class ProcesoEmisionCorCdMAdapter extends SiatAdapterModel{
	
	private static final long serialVersionUID = 1L;
	
	public static final String NAME = "procesoEmisionCorCdMAdapterVO";
	public static final String ENC_NAME = "emisionCorCdMAdapterVO";
	...
	// Constructores
	public ProcesoEmisionCorCdMAdapter(){
