 ...
 * @author tecso
 */
public class RescateIndividualAdapter extends SiatAdapterModel{
	
	private static final long serialVersionUID = 1L;

	public static final String NAME = "rescateIndividualAdapterVO";
    ...
    // Constructores
    public RescateIndividualAdapter(){
