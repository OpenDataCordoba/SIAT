	...
	<fieldset>
		...
		<table class="tabladatos">
			...
			<tr>
				...
				<td class="normal">
					<html:text name="areaAdapterVO" property="area.codArea" size="15" maxlength="20" />
				</td>
			</tr>
			<!-- TextDescripcion -->
			<tr>
				<td><label>(*)&nbsp;<bean:message bundle="def" key="def.area.desArea.label"/>: </label></td>
				<td class="normal"><html:text name="areaAdapterVO" property="area.desArea" size="20" maxlength="100"/></td>			
			</tr>
		</table>
	</fieldset>	
	<!-- Area -->
	...
	<table class="tablabotones" width="100%" >
	   	<tr>
   	    	...
   	    	<td align="right" width="50%">
				...
				<logic:equal name="areaAdapterVO" property="act" value="agregar">
