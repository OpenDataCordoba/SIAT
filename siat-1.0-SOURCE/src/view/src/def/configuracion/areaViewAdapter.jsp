		...
		<table class="tablabotones">
	    	<tr>
  	    		<td align="left">
	   	    	...
	   	    	<td align="left">
	   	    	   <logic:equal name="areaAdapterVO" property="act" value="ver">
					...
					<logic:equal name="areaAdapterVO" property="act" value="activar">
						<html:button property="btnAccionBase"  styleClass="boton" onclick="submitForm('activar', '');">
							<bean:message bundle="base" key="abm.button.activar"/>
						</html:button>
					</logic:equal>
					<logic:equal name="areaAdapterVO" property="act" value="desactivar">
	   	...
	   	<input type="hidden" name="name"  value="<bean:write name='areaAdapterVO' property='name'/>" id="name"/>
