		...
		<fieldset>
			...
			<table class="tabladatos">
				...
				<tr>
					...
					<td class="normal">
						<html:select name="recAliAdapterVO" property="recAli.recTipAli.id" styleClass="select" onchange="submitForm('paramTipoAlicuota', '');">
							<html:optionsCollection name="recAliAdapterVO" property="listRecTipAli" label="desTipoAlicuota" value="id" />
						</html:select>
					</td>
				</tr>
				<tr>
					<td><label>(*)&nbsp;<bean:message bundle="def" key="def.recAli.alicuota.label"/>: </label></td>
					<td class="normal"><html:text name="recAliAdapterVO" property="recAli.alicuota" size="10" maxlength="10"/></td>
				</tr>
				
				<tr>
					<td><label>(*)&nbsp;<bean:message bundle="def" key="def.recAli.fechaDesde.label"/>: </label></td>
					<td class="normal">
						<html:text name="recAliAdapterVO" property="recAli.fechaDesdeView" styleId="fechaDesdeView" size="10" maxlength="10" styleClass="datos" />
						<a class="link_siat" onclick="return show_calendar('fechaDesdeView');" id="a_fechaDesdeView">
							<img border="0" src="<%= request.getContextPath()%>/images/calendario.gif"/></a>
					</td>
					<td><label>(*)<bean:message bundle="def" key="def.recAli.fechaHasta.label"/>: </label></td>
					<td class="normal">
						<html:text name="recAliAdapterVO" property="recAli.fechaHastaView" styleId="fechaHastaView" size="10" maxlength="10" styleClass="datos" />
				...
				<tr>
					...
					<td class="normal"><html:text name="recAliAdapterVO" property="recAli.observacion" size="10" maxlength="10"/></td>
				</tr>		
			</table>
		</fieldset>
		<!-- Fin RecAli -->
	    	...
	    	<tr>
  	    		<td align="left" width="50%">
   	    		...
   	    		<td align="right" width="50%">	   	    	
					<logic:equal name="recAliAdapterVO" property="act" value="modificar">
						<html:button property="btnAceptar"  styleClass="boton" onclick="submitForm('modificar', '');">
							<bean:message bundle="base" key="abm.button.modificar"/>
						</html:button>
					</logic:equal>
					<logic:equal name="recAliAdapterVO" property="act" value="agregar">
