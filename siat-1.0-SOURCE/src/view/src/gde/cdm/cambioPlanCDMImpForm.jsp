...
<html:form styleId="filter" action="/gde/AdministrarCambioPlanCDM.do">
	...
	<h1><bean:message bundle="rec" key="rec.cambioPlanCDMAdapter.impForm.title"/></h1>	
	<fieldset style="clear: both;">
		<p>
			<iframe src="<%=request.getContextPath()%>/gde/AdministrarCambioPlanCDM.do?method=getFormPDF" height="500" width="650">
			</iframe>
		</p>
    </fieldset>	
