...
<html:form styleId="filter" action="/gde/AdministrarCambioPlanCDM.do">
	...
	<table class="tramonline" border="0" cellpadding="0" cellspacing="1" width="100%">
    	<caption><bean:message bundle="rec" key="rec.cambioPlanCDMAdapter.deudaEnCuotaSaldo.title"/></caption>
      	<tbody>
	       	<tr>
	...
	<div align="center">
		<button type="button" name="btnImprCuotas" class="boton" onclick="submitForm('printReciboCuotaSaldo', '');">
