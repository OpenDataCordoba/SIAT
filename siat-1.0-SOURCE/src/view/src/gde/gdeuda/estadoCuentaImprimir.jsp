...
<html:form styleId="filter" action="/gde/AdministrarLiqEstadoCuenta.do">
	...
	<h1><bean:message bundle="gde" key="gde.liqEstadoCuentaAdapter.imprimir.title"/></h1>	
	...
	<fieldset style="clear: both;">
		<p>
			<iframe src="<%=request.getContextPath()%>/gde/AdministrarLiqEstadoCuenta.do?method=imprimir" height="500" width="650">
			</iframe>
		</p>
	...
	<logic:notEqual name="userSession" property="isAnonimoView" value="1">
		<!-- Volver -->
		<button type="button" name="btnVolver" class="boton" onclick="submitForm('volverFromDetalle', '');">
	  	    <bean:message bundle="base" key="abm.button.volver"/>
		</button>
	</logic:notEqual>
