...
<html:form styleId="filter" action="/gde/AdministrarLiqReclamoCuota.do">
	...
	<table class="tablabotones" width="100%">
		<tr>
			<td align="left">
				<p>
						<%=ar.gov.rosario.siat.fra.iface.util.Frase.getInstance().getMessageBykey("gde.reclamoAsentamientoCuota.textoAyudaEncabezadoParrafoUno")%>
					</p>
					<p>
						<%=ar.gov.rosario.siat.fra.iface.util.Frase.getInstance().getMessageBykey("gde.reclamoAsentamientoCuota.textoAyudaEncabezadoParrafoDos")%>
					</p>
					<p>	
						<%=ar.gov.rosario.siat.fra.iface.util.Frase.getInstance().getMessageBykey("gde.reclamoAsentamientoCuota.textoAyudaEncabezadoParrafoTres")%>
					</p>
			</td>				
			<td align="right">
	 			<button type="button" name="btnVolver" class="boton" onclick="submitForm('volverAConvenio', '<bean:write name="liqReclamoAdapterVO" property="liqReclamo.idConvenio" bundle="base" formatKey="general.format.id"/>');">
	...
	<fieldset>
		...
		<dl class="listahorizontalSiat">
     	...
     	<dl class="listahorizontalSiat">   	     	   	
     	   	<dt><bean:message bundle="gde" key="gde.liqReclamo.DesPlan.label"/>:  </dt> 
     	   		<dd><bean:write name="liqReclamoAdapterVO" property="liqReclamo.desPlan"/></dd>
		</dl>
		<dl class="listahorizontalSiat">
			<dt><bean:message bundle="gde" key="gde.liqReclamo.NumeroCuota.label"/>:  </dt> 
				<dd><bean:write name="liqReclamoAdapterVO" property="liqReclamo.numeroCuota"/></dd>		
		</dl>
		<dl class="listahorizontalSiat">
		...
		<fieldset>
	  	...
	  	<div style="text-align:center">
			...
			<button type="button" name="btnVolver" class="boton" onclick="submitForm('volverAConvenio', '<bean:write name="liqReclamoAdapterVO" property="liqReclamo.idConvenio" bundle="base" formatKey="general.format.id"/>');">
	  		...
	  		<button type="button" name="btnRegistrar" onclick="submitForm('registrarReclamo', '<bean:write name="liqReclamoAdapterVO" property="liqReclamo.idCuota" bundle="base" formatKey="general.format.id"/>');" class="boton">
