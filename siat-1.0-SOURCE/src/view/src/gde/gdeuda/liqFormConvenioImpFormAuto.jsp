...
<html:form styleId="filter" action="/gde/AdministrarLiqFormConvenio.do">
	...
	<table class="tablabotones" width="100%">
		<tr>			
			<td align="right">
    			<html:button property="btnVolver"  styleClass="boton" onclick="submitForm('alternativaCuotas', '');">
	...
	<fieldset style="clear: both;">
		<p>
			<iframe src="<%=request.getContextPath()%>/gde/AdministrarLiqFormConvenio.do?method=getFormAutoPDF" height="500" width="650">
			</iframe>
		</p>
    </fieldset>	
