...
<html:form styleId="filter" action="/gde/AdministrarLiqReconfeccion.do">
	...
	<h1><bean:message bundle="gde" key="gde.liqImprimirInformeDeuda.title"/></h1>
	...
	<fieldset style="clear: both;">
		<p>
			<iframe src="<%=request.getContextPath()%>/gde/AdministrarLiqDeuda.do?method=imprimirLiqDeuda" height="500" width="650">
			</iframe>
		</p>
