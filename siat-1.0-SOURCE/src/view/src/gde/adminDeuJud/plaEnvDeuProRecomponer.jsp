...
<html:form styleId="filter" action="/gde/AdministrarPlaEnvDeuPro.do">
	...
	<h1><bean:message bundle="gde" key="gde.plaEnvDeuProAdapter.recomponer.title"/></h1>	
	<fieldset style="clear: both;">
		<p>
			<iframe src="<%=request.getContextPath()%>/gde/AdministrarPlaEnvDeuPro.do?method=recomponerPlanilla" height="500" width="650">
			</iframe>
		</p>
