...
<%@ taglib uri="/tags/struts-logic" prefix="logic" %>
	...
	<html:form styleId="filter" action="/gde/AdministrarDeudaExcProMasPlanillasDeuda.do">
		...
		<!-- Planillas de Deuda de la seleccion de deuda incluida -->
		<fieldset>
			<legend><bean:message bundle="gde" key="gde.deudaProMasPlanillasDeudaAdapter.planillasDeudaDeudaExcluir.title"/></legend>
			<table class="tramonline" border="0" cellpadding="0" cellspacing="1" width="100%">
				<caption><bean:message bundle="gde" key="gde.deudaProMasPlanillasDeudaAdapter.planillasDeuda.title"/></caption>
	           	<tbody>
					...
					<logic:iterate id="PlanillaVO" name="deudaProMasPlanillasDeudaAdapterVO" property="procesoMasivo.selAlmExc.listPlanilla">
						<tr>
							<!-- Ver -->
							<td>	
					...
					<tr>
						...
						<td><bean:write name="deudaProMasPlanillasDeudaAdapterVO" property="procesoMasivo.selAlmExc.ctdTotalRegistrosView" /></td>
					</tr>
				</tbody>
			</table>
		</fieldset>
