...
<html:form styleId="filter" action="/gde/AdministrarDeudaExcProMasEliminar.do">
	...
	<h1><bean:message bundle="gde" key="gde.deudaExcProMasEliminarSelecIndSearchPage.title"/></h1>	
		
	<p><bean:message bundle="gde" key="gde.deudaExcProMasEliminarSelecIndSearchPage.legend"/></p>
		
	<!-- Parametros de la Deuda -->
    <fieldset>
    	<legend><bean:message bundle="gde" key="gde.deudaExcProMasEliminarSelecIndSearchPage.paramDeuda.title"/></legend>
		<table class="tabladatos">
			...
			<tr>
				...
				<td class="normal" colspan="3"><bean:write name="deudaExcProMasEliminarSearchPageVO" property="cuenta.numeroCuenta" />	</td>
			</tr>
			<logic:iterate id="item" name="deudaExcProMasEliminarSearchPageVO" property="listRecClaDeu">
				<tr>					
					<td>
					...
					<td class="normal" colspan="3"> <bean:write name="item" property="desClaDeu"/> &nbsp;</td> 
				</tr>
			</logic:iterate>
			<tr>
				<td><label><bean:message bundle="gde" key="gde.deudaExcProMasEliminarSearchPage.fechaVencimientoDesde.label"/>: </label></td>
				<td class="normal">
					<bean:write name="deudaExcProMasEliminarSearchPageVO" property="fechaVencimientoDesdeView" /> 
				</td>
				<td><label><bean:message bundle="gde" key="gde.deudaExcProMasEliminarSearchPage.fechaVencimientoHasta.label"/>: </label></td>
				<td class="normal">
					<bean:write name="deudaExcProMasEliminarSearchPageVO" property="fechaVencimientoHastaView" />
				</td>
			</tr>
		</table>
	</fieldset>
				...
				<table class="tramonline" border="0" cellpadding="0" cellspacing="1" width="100%">
					<caption><bean:message bundle="base" key="base.resultadoBusqueda"/></caption>
	               	<tbody>
						...
						<logic:iterate id="SelAlmDetVO" name="deudaExcProMasEliminarSearchPageVO" property="listResult">
							<tr>
								<!-- Check -->
								<td>	
									<html:multibox name="deudaExcProMasEliminarSearchPageVO" property="listIdSelAlmDet">
				...
				<logic:notEmpty  name="deudaExcProMasEliminarSearchPageVO" property="listResult">	
					<td align="right">
						<html:button property="btnSeleccionIndividual"  styleClass="boton" onclick="submitForm('eliminarSeleccionIndividual', '');">
							<bean:message bundle="gde" key="gde.deudaExcProMasEliminarSelecIndSearchPage.eliminar.label"/>
						</html:button>
					</td>
				</logic:notEmpty>
			</logic:equal>
