...
<%@ taglib uri="/tags/struts-logic" prefix="logic" %>
	...
	<html:form styleId="filter" action="/gde/AdministrarProMasRepDeudaExc.do">
		...
		<!-- Reportes de Deuda Excluida -->
		<fieldset>
			<legend><bean:message bundle="gde" key="gde.procesoMasivoReportesDeudaAdapter.reportesDeudaExcluir.title"/></legend>
			<table class="tramonline" border="0" cellpadding="0" cellspacing="1" width="100%">
				<caption><bean:message bundle="gde" key="gde.procesoMasivoReportesDeudaAdapter.reportes.title"/></caption>
	           	<tbody>
					...
					<logic:iterate id="PlanillaVO" name="procesoMasivoReportesDeudaAdapterVO" property="procesoMasivo.listReportesDeudaExcluida">
						<tr>
							<!-- Ver -->
							<td>	
					...
					<tr>
						...
						<td><bean:write name="procesoMasivoReportesDeudaAdapterVO" property="procesoMasivo.ctdTotalRegistrosDeudaExcluidaView" /></td>
					</tr>
				</tbody>
			</table>
		</fieldset>
		<!-- Fin Reportes de Deuda Excluida -->
