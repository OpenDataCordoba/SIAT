	...
	<fieldset>
		...
		<table class="tabladatos">
			<tr>
				...
				<td class="normal" colspan="3">	<bean:write name="proMasProExcAdapterVO" property="proMasProExc.procurador.descripcion" />	</td>
			</tr>
			<tr>
				<td><label><bean:message bundle="gde" key="gde.proMasProExc.observacion.label"/>: </label></td>
				<td class="normal" colspan="3">	<bean:write name="proMasProExcAdapterVO" property="proMasProExc.observacion" />	</td>
			</tr>
		</table>
	</fieldset>	
	...
	<table class="tablabotones" width="100%" >
	   	<tr>
   	    	...
   	    	<td align="right" width="50%">
				<logic:equal name="proMasProExcAdapterVO" property="act" value="eliminar">
