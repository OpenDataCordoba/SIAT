...
<%@ taglib uri="/tags/struts-logic" prefix="logic" %>
	...
	<html:form styleId="filter" action="/gde/AdministrarDeudaIncProMasArmadoSeleccion.do">
		...
		<!-- Logs de la seleccion de deuda incluida -->
		<fieldset>
			<legend><bean:message bundle="gde" key="gde.deudaProMasArmadoSeleccionAdapter.logsSeleccionDeudaIncluir.title"/></legend>
			<table class="tramonline" border="0" cellpadding="0" cellspacing="1" width="100%">
				<caption><bean:message bundle="gde" key="gde.deudaProMasArmadoSeleccionAdapter.detalleLog.title"/></caption>
	           	<tbody>
					...
					<logic:iterate id="SelAlmLogVO" name="deudaProMasArmadoSeleccionAdapterVO" property="procesoMasivo.selAlmInc.listSelAlmLog">
						<tr>
