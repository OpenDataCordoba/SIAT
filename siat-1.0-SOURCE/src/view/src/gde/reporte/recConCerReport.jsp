...
<html:form styleId="filter" action="/gde/ReporteRecConCer.do" >
	...
	<h1><bean:message bundle="gde" key="gde.recConCerReport.title"/></h1>	
		
	<p><bean:message bundle="gde" key="gde.recConCerReport.legend"/></p>
