...
<html:form styleId="filter" action="/gde/ReporteRecaudacionCer.do" >
	...
	<h1><bean:message bundle="gde" key="gde.recaudacionCerReport.title"/></h1>	
		
	<p><bean:message bundle="gde" key="gde.recaudacionCerReport.legend"/></p>
