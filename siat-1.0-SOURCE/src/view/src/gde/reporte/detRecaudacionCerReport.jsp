...
<html:form styleId="filter" action="/gde/ReporteDetRecaudacionCer.do" >
	...
	<h1><bean:message bundle="gde" key="gde.detRecaudacionCerReport.title"/></h1>	
		
	<p><bean:message bundle="gde" key="gde.detRecaudacionCerReport.legend"/></p>
