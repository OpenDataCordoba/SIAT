...
<html:form styleId="filter" action="/ef/BuscarActaInv.do">
					...
					<caption><bean:message bundle="base" key="base.resultadoBusqueda"/></caption>
	               	<tbody>
		               	<tr>
							...
							<th><bean:message bundle="ef" key="ef.opeInvConActas.asignInv.fechaVisita.label"/></th>
						...
						<logic:iterate id="OpeInvConVO" name="opeInvConSearchPageVO" property="listResult">
							<tr>
								...
								<!-- Acta -->
									<td>
										<logic:equal name="opeInvConSearchPageVO" property="actaEnabled" value="enabled">									
											<a style="cursor: pointer; cursor: hand;" onclick="submitForm('acta', '<bean:write name="OpeInvConVO" property="id" bundle="base" formatKey="general.format.id"/>');">
												<img title="<bean:message bundle="ef" key="ef.opeInvConSearchPage.button.acta"/>" border="0" src="<%=request.getContextPath()%>/images/iconos/actaEf0.gif"/>
											</a>
										</logic:equal>
										<logic:notEqual name="OpeInvConVO" property="verEnabled" value="enabled">
											<img border="0" src="<%=request.getContextPath()%>/images/iconos/actaEf1.gif"/>
										</logic:notEqual>
									</td>
