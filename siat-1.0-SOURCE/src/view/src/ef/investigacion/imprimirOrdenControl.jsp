...
<html:form styleId="filter" action="/ef/AdministrarOrdenControl.do">
	...
	<h1><bean:message bundle="ef" key="ef.ordenControlAdapter.imprimir.title"/></h1>	
	...
	<fieldset style="clear: both;">
		<p>
			<iframe src="<%=request.getContextPath()%>/ef/AdministrarOrdenControl.do?method=impresionPDF" height="500" width="650">
			</iframe>
		</p>
       </fieldset>	
