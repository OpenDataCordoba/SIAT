...
public final class AdministrarLiqFormConvenioDAction extends BaseDispatchAction {

	private Log log = LogFactory.getLog(AdministrarLiqFormConvenioDAction.class);
	
	
	/**
	 * Metodo que se llama desde la liquidacion de la deuda cyq
	 * 
	 */
	public ActionForward inicializar(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			return mapping.findForward(CyqConstants.FWD_FORMCONVENIO_ADAPTER);
	...
	public ActionForward seleccionarPlan(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			// Llamada al servicio
			liqFormConvenioAdapterVO = CyqServiceLocator.getConcursoyQuiebraService().getPlanes(userSession, liqFormConvenioAdapterVO);
	...
	public ActionForward verDetallePlan(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			return 	baseForward(mapping,request, funcName, BaseConstants.ACT_REFILL, CyqConstants.FWD_VER_DETALLE_PLAN , BaseConstants.ACT_VER); 
	...
	public ActionForward alternativaCuotas(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			// Llamada al servicio
			liqFormConvenioAdapterVO = CyqServiceLocator.getConcursoyQuiebraService().getAlternativaCuotas(userSession, liqFormConvenioAdapterVO);
			...
			return mapping.findForward(CyqConstants.FWD_FORMCONVENIO_CUOTAS_ADAPTER);
	...
	public ActionForward verSimulacionCuotas(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			// Llamada al servicio
			liqFormConvenioAdapterVO = CyqServiceLocator.getConcursoyQuiebraService().getSimulacionCuotas(userSession, liqFormConvenioAdapterVO);
			...
			return mapping.findForward(CyqConstants.FWD_FORMCONVENIO_SIMULA_CUOTAS_ADAPTER);
	...
	public ActionForward formalizarPlan(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			if (request.getParameter("nroCuota") != null){
				...
				liqFormConvenioAdapterVO.addRecoverableError(CyqError.MSG_NRO_CUOTA_REQUERIDO);
			}
	...
	public ActionForward grabarFormalizacion(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			// Llamada al servicio
			liqFormConvenioAdapterVO = CyqServiceLocator.getConcursoyQuiebraService().formalizarPlan(userSession, liqFormConvenioAdapterVO);
			...
			navModel.setConfAction("/cyq/AdministrarLiqFormConvenio");
	...
	public ActionForward getConvenioFormalizado(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			return mapping.findForward(CyqConstants.FWD_FORMCONVENIO_PRINT_ADAPTER);
	...
	public ActionForward buscarPersona(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			return forwardSeleccionar(mapping, request, 
					CyqConstants.METOD_FORMCONVENIO_PARAM_PERSONA, PadConstants.ACTION_BUSCAR_PERSONA, true);
	...
	public ActionForward paramPersona(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			liqFormConvenioAdapterVO = CyqServiceLocator.getConcursoyQuiebraService().paramPersona(userSession, liqFormConvenioAdapterVO, new Long(selectedId));
	...
	public ActionForward printForm(ActionMapping mapping, ActionForm form,
		...
		LiqFormConvenioAdapter liqFormConvenioAdapterVO = (LiqFormConvenioAdapter) userSession.get(LiqFormConvenioAdapter.NAME);		
		liqFormConvenioAdapterVO.setPrevActionParameter(CyqConstants.ACTION_FORMCONVENIOCYQ);
		
		return mapping.findForward(CyqConstants.FWD_FORMCONVENIO_IMP_FORM);		
	}
	...
	public ActionForward printRecibos(ActionMapping mapping, ActionForm form,
		...
		return mapping.findForward(CyqConstants.FWD_FORMCONVENIO_IMP_RECIBOS);		
	}
	...
	public ActionForward printAltCuotas(ActionMapping mapping, ActionForm form,
		...
		return mapping.findForward(CyqConstants.FWD_FORMCONVENIO_IMP_ALTCUOTAS);		
	}
	...
	public ActionForward getAltCuotasPDF(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			// Llamada al servicio
//PrintModel print  = CyqServiceLocator.getConcursoyQuiebraService().getPrintAltCuotas(userSession, liqFormConvenioAdapterVO);
			...
			baseResponsePrintModel(response, new PrintModel());
			return null;
		} catch (Exception exception) {
			return baseException(mapping, request, funcName, exception,
					LiqFormConvenioAdapter.NAME);
...
/*	public ActionForward getFormPDF(ActionMapping mapping, ActionForm form,
		...
		//UserSession userSession = canAccess(request, mapping, CyqSecurityConstants.LIQ_CONVENIOCUENTA, GdeSecurityConstants.MTD_IMPRIMIR_FORM_CONVENIO);
		UserSession userSession = getCurrentUserSession(request, mapping);
		if (userSession == null)
			return forwardErrorSession(request);
		String stringServicio = "getPrintForm";
		try {
			...
			// Llamada al servicio
			PrintModel print  = CyqServiceLocator.getConcursoyQuiebraService().getPrintForm(userSession, liqFormConvenioAdapterVO);
	...
	public ActionForward volverACuotasEsp(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		...
		try {
			...
			return new ActionForward("/cyq/AdministrarLiqFormConvenioEsp.do?method=volverACuotas");
	...
	/*******************************************************************************************************************
	 * 
	 *			Metodo Dummy para acceder a la ultima pantalla de formalizacion y porder confeccionar asi los xsl 
	 *			para la impresion. 
	 * 
	 ******************************************************************************************************************/	
	public ActionForward dummy(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		...
		try {
			...
			liqFormConvenioAdapterVO.getConvenio().setIdConvenio(new Long(request.getParameter("id")));
