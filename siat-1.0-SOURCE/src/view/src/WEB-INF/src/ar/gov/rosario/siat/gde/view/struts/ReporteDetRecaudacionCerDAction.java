...
public final class ReporteDetRecaudacionCerDAction extends BaseDispatchAction {
	...
	public ActionForward inicializar(ActionMapping mapping, ActionForm form,
		...
		UserSession userSession = canAccess(request, mapping, GdeSecurityConstants.DETRECAUDACIONCER_REPORT, act);
		if (userSession==null) return forwardErrorSession(request);
		
		try {
			
			ContribuyenteCerReport contribuyenteCerReportVO = GdeServiceLocator.getReporteService().getDetRecaudacionCerReportInit(userSession);
	...
	public ActionForward buscar(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			// Llamada al servicio	
			contribuyenteCerReportVO = GdeServiceLocator.getReporteService().getDetRecaudacionCerReportResult(userSession, contribuyenteCerReportVO);			
