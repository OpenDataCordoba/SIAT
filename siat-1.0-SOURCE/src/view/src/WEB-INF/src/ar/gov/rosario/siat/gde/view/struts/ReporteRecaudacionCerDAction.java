...
public final class ReporteRecaudacionCerDAction extends BaseDispatchAction {
	...
	public ActionForward inicializar(ActionMapping mapping, ActionForm form,
		...
		UserSession userSession = canAccess(request, mapping, GdeSecurityConstants.RECAUDACIONCER_REPORT, act);
		if (userSession==null) return forwardErrorSession(request);
		
		try {
			
			ContribuyenteCerReport contribuyenteCerReportVO = GdeServiceLocator.getReporteService().getRecaudacionCerReportInit(userSession);
			...
			return mapping.findForward(GdeConstants.FWD_RECAUDACIONCER_REPORT);
	...
	public ActionForward buscar(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			// Llamada al servicio	
			contribuyenteCerReportVO = GdeServiceLocator.getReporteService().getRecaudacionCerReportResult(userSession, contribuyenteCerReportVO);			
			...
			return mapping.findForward(GdeConstants.FWD_DETRECAUDACIONCER_REPORT);
