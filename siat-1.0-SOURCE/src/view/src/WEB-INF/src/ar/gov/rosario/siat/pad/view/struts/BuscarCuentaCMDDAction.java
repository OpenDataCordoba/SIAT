...
public final class BuscarCuentaCMDDAction extends BaseDispatchAction {

	private Log log = LogFactory.getLog(BuscarCuentaCMDDAction.class);
	...
	public ActionForward inicializar(ActionMapping mapping, ActionForm form,
		...
		UserSession userSession = canAccess(request, mapping, PadSecurityConstants.ABM_CUENTA, PadSecurityConstants.MTD_BUSCAR_CMD);		
		if (userSession==null) return forwardErrorSession(request);
		
		try {
			CuentaSearchPage cuentaSearchPageFiltro = new CuentaSearchPage();
			cuentaSearchPageFiltro.setEsCMD(true);
			...
			return mapping.findForward(PadConstants.FWD_CUENTACMD_SEARCHPAGE);
