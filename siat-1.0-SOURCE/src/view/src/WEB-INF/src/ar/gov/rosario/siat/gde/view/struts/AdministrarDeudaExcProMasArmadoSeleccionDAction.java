...
// Administra los logs de armado de la deuda a incluir del proceso de envio a judicial

// ver si podemos incluir la agregacion de toda

public final class AdministrarDeudaExcProMasArmadoSeleccionDAction extends BaseDispatchAction {

	private Log log = LogFactory.getLog(AdministrarDeudaExcProMasArmadoSeleccionDAction.class);
	...
	public ActionForward inicializar(ActionMapping mapping, ActionForm form,
			...
			try {
				...
				// obtengo el id del envio judicial simplemente con el selectedId cargado desde el jsp
				...
				if (act.equals(GdeConstants.ACT_LOGS_ARMADO_DEUDA_PRO_MAS)) {
					...
					deudaIncProMasLogsArmadoAdapterVO = GdeServiceLocator.getGestionDeudaJudicialService().getDeudaExcProMasArmadoSeleccionAdapter(userSession, commonKey);
					deudaIncProMasLogsArmadoAdapterVO.setEsLimpiarSeleccion(false);
					actionForward = mapping.findForward(GdeConstants.FWD_DEUDA_EXC_PRO_MAS_ARMADO_SELECCION_ADAPTER);
				}
	...
	public ActionForward limpiarSeleccion(ActionMapping mapping, ActionForm form,
			...
			try {
				...
				// llamada al servicio
				SelAlmDeudaVO selAlmDeudaVO = GdeServiceLocator.getGestionDeudaJudicialService().limpiarSelAlmDetDeudaExcluidaProcesoMasivo(userSession, 
