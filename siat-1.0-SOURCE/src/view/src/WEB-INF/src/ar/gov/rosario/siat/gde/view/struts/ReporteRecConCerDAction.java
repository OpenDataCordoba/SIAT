...
public final class ReporteRecConCerDAction extends BaseDispatchAction {
	...
	public ActionForward inicializar(ActionMapping mapping, ActionForm form,
		...
		UserSession userSession = canAccess(request, mapping, GdeSecurityConstants.RECCONCER_REPORT, act);
		if (userSession==null) return forwardErrorSession(request);
		
		try {
			
			ContribuyenteCerReport contribuyenteCerReportVO = GdeServiceLocator.getReporteService().getRecConCerReportInit(userSession);
			...
			return mapping.findForward(GdeConstants.FWD_RECCONCER_REPORT);
	...
	public ActionForward buscar(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			// Llamada al servicio	
			contribuyenteCerReportVO = GdeServiceLocator.getReporteService().getRecConCerReportResult(userSession, contribuyenteCerReportVO);			
