...
<html:form styleId="filter" action="/pad/AdministrarEstCue.do">
	...
	<h1><bean:message bundle="pad" key="pad.estCueEditAdapter.title"/></h1>	
	...
	<fieldset>
		...
		<table class="tabladatos">
			...
			<tr>
				...
				<td class="normal"><html:text name="estCueAdapterVO" property="estCue.descripcion" size="20" maxlength="100"/></td>			
			</tr>
			<!-- <#Campos#> -->
		</table>
	</fieldset>	
	...
	<table class="tablabotones" width="100%" >
	   	<tr>
   	    	...
   	    	<td align="right" width="50%">
				<logic:equal name="estCueAdapterVO" property="act" value="modificar">
					<html:button property="btnAceptar"  styleClass="boton" onclick="submitForm('modificar', '');">
						<bean:message bundle="base" key="abm.button.modificar"/>
					</html:button>
				</logic:equal>
				<logic:equal name="estCueAdapterVO" property="act" value="agregar">
