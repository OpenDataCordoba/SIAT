	...
	<table class="tablabotones" width="100%">
		...
		<fieldset width="100%">
			...
			<tr>
				...
				<td class="normal">
					<html:select name="cuentaTitularAdapterVO" property="cuentaTitular.tipoTitular.id" styleClass="select">
						<html:optionsCollection name="cuentaTitularAdapterVO" property="listTipoTitular" label="desTipoTitular" value="id" />
					</html:select>
				</td>
			</tr>
			<tr>	
				...
				<td class="normal" >
					<html:select name="cuentaTitularAdapterVO" property="cuentaTitular.esTitularPrincipal.id" styleClass="select">
						<html:optionsCollection name="cuentaTitularAdapterVO" property="listEsTitularPrincipal" label="value" value="id" />
					</html:select>
				</td>
				<td colspan="2" class="normal">
					<ul class="vinieta"><li><bean:message bundle="pad" key="pad.cuentaTitular.titularPrincipal.aclaracion"/></li></ul>
				</td>
			</tr>
			<tr>
				<td><label>(*)&nbsp;<bean:message bundle="pad" key="pad.cuentaTitular.fechaDesde.label"/>: </label></td>
				<td class="normal">
					<html:text name="cuentaTitularAdapterVO" property="cuentaTitular.fechaDesdeView" styleId="fechaDesdeView" size="10" maxlength="10" styleClass="datos" />
				...
				<td class="normal">
					<html:text name="cuentaTitularAdapterVO" property="cuentaTitular.fechaHastaView" styleId="fechaHastaView" size="10" maxlength="10" styleClass="datos" />
	      ...
	      <table class="tablabotones" width="100%">
	            <tr>
	               ...
	               <td align="right" width="50%">
		               <logic:equal name="cuentaTitularAdapterVO" property="act" value="modificar">
		                  <html:button property="btnAccionBase"  styleClass="boton" onclick="submitForm('modificar', '');">
		                     <bean:message bundle="base" key="abm.button.modificar"/>
		                  </html:button>
		               </logic:equal>
		               <logic:equal name="cuentaTitularAdapterVO" property="act" value="agregar">
