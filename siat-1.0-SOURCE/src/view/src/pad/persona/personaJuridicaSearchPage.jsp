...
<html:form styleId="filter" action="/pad/BuscarPersona.do">
	...
	<legend><bean:message bundle="base" key="base.parametrosBusqueda"/></legend>
		<table class="tabladatos">
			...
			<tr>
				...
				<td class="normal"><html:text name="personaSearchPageVO" property="persona.razonSocial" size="20" maxlength="25" styleClass="datos" /></td>
					...
					<caption><bean:message bundle="base" key="base.resultadoBusqueda"/></caption>
	               	<tbody>
		               	<tr>
							...
							<th align="left"><bean:message bundle="pad" key="pad.persona.razonSocial.label"/></th>
							<th align="left"><bean:message bundle="pad" key="pad.persona.cuit.label"/></th>
							<th align="left"><bean:message bundle="pad" key="pad.domicilio.label"/></th>							
						...
						<logic:iterate id="PersonaVO" name="personaSearchPageVO" property="listResult">
							<tr>
								...
								<td><bean:write name="PersonaVO" property="razonSocial"/>&nbsp;</td>
								<td><bean:write name="PersonaVO" property="cuit" />&nbsp;</td>
								<td><bean:write name="PersonaVO" property="domicilio.view" />&nbsp;</td>
	...
	<table class="tablabotones">
		<tr>				
			...
			<!-- no tiene boton agregar porque desde SIAT no agregamos personas juridicas -->
		</tr>
	</table>
