	...
	<html:form styleId="filter" action="/pad/AdministrarContribuyente.do">
		...
		<fieldset>
			...
			<table class="tablabotones" width="100%">
				<tr>				
					<td align="right">
						<bean:define id="modificarPersonaEnabled" name="contribuyenteAdapterVO" property="modificarPersonaEnabled"/>
						<input type="button" class="boton" <%=modificarPersonaEnabled%> onClick="submitForm('modificarPersona', 
							'<bean:write name="contribuyenteAdapterVO" property="contribuyente.id" bundle="base" formatKey="general.format.id"/>');" 
							value="<bean:message bundle="pad" key="pad.button.modificarPersona"/>"/>
					</td>
				</tr>
			</table>
		</fieldset>
		...
		<fieldset>
			...
			<table class="tabladatos">
				...
				<tr>
					...
					<td colspan="3">
						<bean:define id="IncludedVO" name="contribuyenteAdapterVO" property="contribuyente"/>
				...
				<tr>
					...
					<td class="normal"><bean:write name="contribuyenteAdapterVO" property="contribuyente.nroIsib"/></td>
				</tr>
				<tr>
				...
				<tr>				
					<td align="right" colspan="4">
						<bean:define id="modificarEncabezadoEnabled" name="contribuyenteAdapterVO" property="modificarEncabezadoEnabled"/>
						<input type="button" class="boton" <%=modificarEncabezadoEnabled%> onClick="submitForm('modificarEncabezado', 
							'<bean:write name="contribuyenteAdapterVO" property="contribuyente.id" bundle="base" formatKey="general.format.id"/>');" 
							value="<bean:message bundle="pad" key="pad.button.modificarContribuyente"/>"/>
					</td>
				</tr>
			</table>
		</fieldset>
			...
			<table class="tramonline" border="0" cellpadding="0" cellspacing="1" width="100%">
				...
				<logic:iterate id="ConAtrDefinition" name="contribuyenteAdapterVO" property="contribuyenteDefinition.listConAtrDefinition">
					<tr>
						...
						<!-- Modificar-->
						<td>
							<logic:equal name="contribuyenteAdapterVO" property="modificarConAtrValEnabled" value="enabled">								
								<a style="cursor: pointer; cursor: hand;"onclick="submitForm('modificarConAtrVal', '<bean:write name="AtrVal" property="idDefinition" bundle="base"formatKey="general.format.id"/>');">
									<img title="<bean:message bundle="base"key="abm.button.modificar"/>" border="0" src="<%=request.getContextPath()%>/images/iconos/modif0.gif"/>
								</a>								
							</logic:equal>
							<logic:notEqual name="contribuyenteAdapterVO" property="modificarConAtrValEnabled" value="enabled">
