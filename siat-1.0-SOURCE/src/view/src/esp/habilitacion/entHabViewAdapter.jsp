		...
		<fieldset>
			...
			<table class="tabladatos">
				<tr>
					...
					<td class="normal"><bean:write name="entHabAdapterVO" property="entHab.precioEvento.descripcion"/></td>
				</tr>
				<tr>
					<td><label>&nbsp;<bean:message bundle="esp" key="esp.entHab.nroDesde.label"/>: </label></td>
					<td class="normal"><bean:write name="entHabAdapterVO" property="entHab.nroDesdeView"/></td>
					<td><label>&nbsp;<bean:message bundle="esp" key="esp.entHab.nroHasta.label"/>: </label></td>
					<td class="normal"><bean:write name="entHabAdapterVO" property="entHab.nroHastaView"/></td>
				</tr>	
				<tr>
					<td><label>&nbsp;<bean:message bundle="esp" key="esp.entHab.serie.label"/>: </label></td>
					<td class="normal"><bean:write name="entHabAdapterVO" property="entHab.serie"/></td>
					<td><label>&nbsp;<bean:message bundle="esp" key="esp.entHab.descripcion.label"/>: </label></td>
					<td class="normal"><bean:write name="entHabAdapterVO" property="entHab.descripcion"/></td>
				</tr>	
			</table>
		</fieldset>
		<!-- Fin EntHab -->
			...
			<tr>				
				<td align="left">
	   	    	...
	   	    	<td align="right" width="50%">
					<logic:equal name="entHabAdapterVO" property="act" value="eliminar">
