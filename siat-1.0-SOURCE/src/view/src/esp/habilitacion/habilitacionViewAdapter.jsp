...
<script type="text/javascript" language="javascript">			   
	...
	<html:form styleId="filter" action="/esp/AdministrarHabilitacion.do">
			...
			<table class="tablabotones" width="100%">
				<tr>
					...
					<tr>
						...
						<td class="normal"><bean:write name="habilitacionAdapterVO" property="habilitacion.claOrg.value"/></td>
						</td>
					</tr>
				</tr>
			</table>
		...
		<logic:equal name="habilitacionAdapterVO" property="act" value="cambiarEstado">
			<fieldset>
			<legend><bean:message bundle="esp" key="esp.estHab.title"/></legend>			
			<table class="tablabotones" width="100%">
				<tr>
					<!-- Estado Habilitacion -->		
					<td><label>&nbsp;<bean:message bundle="esp" key="esp.estHab.label"/>: </label></td>
					<td colspan="3">
						<html:select name="habilitacionAdapterVO" property="habilitacion.estHab.id" styleClass="select" >
							<html:optionsCollection name="habilitacionAdapterVO" property="listEstHab" label="desEstHab" value="id" />
						</html:select>
					</td>
				</tr>
				<tr>
					<!-- Observacion-->		
					<td><label>&nbsp;<bean:message bundle="esp" key="esp.hisEstHab.observaciones.label"/>: </label></td>
					<td colspan="3" class="normal"><html:textarea name="habilitacionAdapterVO" property="obsCambioEstado" cols="75" rows="15"/></td>					
				</tr>					
				</table>
			</fieldset>
		</logic:equal>
			
		<logic:equal name="habilitacionAdapterVO" property="act" value="ver">		
	...
	<!-- Entradas Habilitadas -->		
		...
		<!-- Historio Estados -->		
			<table class="tramonline" border="0" cellpadding="0" cellspacing="1" width="100%">            
				<caption><bean:message bundle="esp" key="esp.habilitacion.listHisEstHab.label"/></caption>
		    	<tbody>
					<logic:notEmpty  name="habilitacionAdapterVO" property="habilitacion.listHisEstHab">	    	
				    	<tr>
							<th align="left"><bean:message bundle="esp" key="esp.hisEstHab.fecha.label"/></th>
							<th align="left"><bean:message bundle="base" key="base.estado.label"/></th>
							<th align="left"><bean:message bundle="esp" key="esp.hisEstHab.observaciones.label"/></th>
							<th align="left"><bean:message bundle="esp" key="esp.hisEstHab.logCambios.label"/></th>						
						</tr>
						<logic:iterate id="HisEstHabVO" name="habilitacionAdapterVO" property="habilitacion.listHisEstHab">
							<tr>
								<td><bean:write name="HisEstHabVO" property="fechaView"/>&nbsp;</td>
								<td><bean:write name="HisEstHabVO" property="estHab.desEstHab"/>&nbsp;</td>
								<td><bean:write name="HisEstHabVO" property="observaciones"/>&nbsp;</td>
								<td><bean:write name="HisEstHabVO" property="logCambios"/>&nbsp;</td>
							</tr>
						</logic:iterate>
					</logic:notEmpty>
					<logic:empty  name="habilitacionAdapterVO" property="habilitacion.listHisEstHab">
						<tr><td align="center">
						<bean:message bundle="base" key="base.noExistenRegitros"/>
						</td></tr>
					</logic:empty>
			...
			<tr>				
				<td align="left">
	   	    	...
	   	    	<td align="right" width="50%">
					<logic:equal name="habilitacionAdapterVO" property="act" value="eliminar">
