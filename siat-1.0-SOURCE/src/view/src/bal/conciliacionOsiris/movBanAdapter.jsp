				...
				<logic:notEmpty  name="movBanAdapterVO" property="movBan.listMovBanDet">	    	
					...
					<logic:iterate id="MovBanDetVO" name="movBanAdapterVO" property="movBan.listMovBanDet">
						<tr>
							...
							<!-- Conciliado-->								
							<td>
								<logic:equal name="movBanAdapterVO" property="conciliarMovBanDetEnabled" value="enabled">
									<logic:equal name="MovBanDetVO" property="conciliarEnabled" value="enabled">
										<a style="cursor: pointer; cursor: hand;" onclick="submitForm('conciliarMovBanDet', '<bean:write name="MovBanDetVO" property="id" bundle="base" formatKey="general.format.id"/>');">
									...
									<logic:notEqual name="MovBanDetVO" property="conciliarEnabled" value="enabled">
										<img border="0" src="<%=request.getContextPath()%>/images/iconos/aceptar1.gif"/>
									</logic:notEqual>
								</logic:equal>
								<logic:notEqual name="movBanAdapterVO" property="conciliarMovBanDetEnabled" value="enabled">
									<img border="0" src="<%=request.getContextPath()%>/images/iconos/aceptar1.gif"/>
								</logic:notEqual>
							</td>
