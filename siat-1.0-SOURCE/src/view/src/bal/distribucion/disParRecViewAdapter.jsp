	...
	<html:form styleId="filter" action="/bal/AdministrarDisParRec.do">
		...
		<fieldset>
			...
			<table class="tabladatos">
				...
				<!-- Valor -->		
				<tr>
					<td><label>&nbsp;<bean:message bundle="bal" key="bal.disParRec.valor.label"/>: </label></td>
					<td class="normal"><bean:write name="disParRecAdapterVO" property="disParRec.valorView"/></td>									
				</tr>
				</logic:equal>
				...
				<tr>
					...
					<td class="normal"><bean:write name="disParRecAdapterVO" property="disParRec.viaDeuda.desViaDeuda"/></td>									
				</tr>
				</logic:equal>
				...
				<tr>
					...
					<td class="normal"><bean:write name="disParRecAdapterVO" property="disParRec.fechaDesdeView"/></td>
					<td><label>&nbsp;<bean:message bundle="bal" key="bal.disParRec.fechaHasta.label"/>: </label></td>
					<td class="normal"><bean:write name="disParRecAdapterVO" property="disParRec.fechaHastaView"/></td>
				</tr>		
			</table>
		</fieldset>
		<!-- Fin DisParRec -->
			...
			<tr>				
				<td align="left">
	   	    	...
	   	    	<td align="right" width="50%">
					<logic:equal name="disParRecAdapterVO" property="act" value="eliminar">
