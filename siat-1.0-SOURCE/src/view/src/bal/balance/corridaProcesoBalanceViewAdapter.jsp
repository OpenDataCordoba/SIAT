...
<html:form styleId="filter" action="/bal/AdministrarCorridaProcesoBalance.do">
		...
		<fieldset>
			...
			<table class="tabladatos">
				...
				<tr>
					...
					<td class="normal"><bean:write name="corridaProcesoBalanceAdapterVO" property="balance.corrida.desCorrida"/></td>
				</tr>
				<!-- Fecha Inicio -->
				<tr>
					<td><label><bean:message bundle="pro" key="pro.corrida.fechaOriginal.ref"/>: </label></td>
					<td class="normal"><bean:write name="corridaProcesoBalanceAdapterVO" property="balance.corrida.fechaInicioView"/></td>
				<!-- Hora Inicio -->
					<td><label><bean:message bundle="pro" key="pro.corrida.horaOriginal.ref"/>: </label></td>
					<td class="normal"><bean:write name="corridaProcesoBalanceAdapterVO" property="balance.corrida.horaInicioView"/></td>
				</tr>
			...
			<tr>				
				<td align="left">
	   	    	...
	   	    	<td align="right" width="50%">
					<logic:equal name="corridaProcesoBalanceAdapterVO" property="act" value="retroceder">
					...
					<logic:equal name="corridaProcesoBalanceAdapterVO" property="act" value="reiniciar">
