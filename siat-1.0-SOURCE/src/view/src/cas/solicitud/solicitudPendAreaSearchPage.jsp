...
<html:form styleId="filter" action="/cas/BuscarSolicitud.do">
	...
	<h1><bean:message bundle="cas" key="cas.solicitudSearchPage.titlePendArea"/></h1>	
	&nbsp;
	...
	<!-- List de solicitudes Pendientes-->
						...
						<logic:iterate id="SolicitudVO" name="solicitudSearchPageVO" property="listResult">
							<tr>
								...
								<td>
									...
									<label>&nbsp;/&nbsp;<bean:message bundle="cas" key="cas.solicitud.areaOrigen.label"/>:</label>&nbsp;
									<bean:write name="SolicitudVO" property="areaOrigen.desArea"/>
	...
	<!-- Fin List de solicitudes Pendientes -->
	...
	<input type="hidden" name="pageMethod" value="getPendientesArea" id="pageMethod">
