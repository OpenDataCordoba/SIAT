...
<html:form styleId="filter" action="/exe/AdministrarDeudaExencion.do">
	...
	<h1><bean:message bundle="exe" key="exe.deudaExencionIngresoAdapter.title"/></h1>	
	...
	<!-- LiqDeuda -->
	<fieldset>
		<legend><bean:message bundle="exe" key="exe.deudaExencionIngresoAdapter.fieldset.title"/></legend>
			...
			<p>
	      		...
	      		<button type="button" onclick="submitForm('buscarCuenta', '');">
	      			<bean:message bundle="exe" key="exe.deudaExencionIngresoAdapter.button.buscarCuenta"/>	      			
	      		</button>
			</p>
		
		  	<div style="text-align:right">
		  		<button type="button" name="btnAceptar" onclick="submitForm('ingresar', '');" class="boton">
		  			<bean:message bundle="exe" key="exe.deudaExencionIngresoAdapter.button.aceptar"/>
		  		</button>
		  	</div>
	</fieldset>	
	<!-- LiqDeuda -->
