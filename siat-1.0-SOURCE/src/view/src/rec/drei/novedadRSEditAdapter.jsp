...
<script type="text/javascript" language="javascript">			   
	...
	<html:form styleId="filter" action="/rec/AdministrarNovedadRS.do">
		...
		<!-- NovedadRS -->
		<fieldset>
			<legend><bean:message bundle="rec" key="rec.novedadRSAdapter.simularAplicar.title"/></legend>
				<!-- Msg Deuda -->
				<p align="left">
		...
		<table class="tablabotones" width="100%">
			<tr>				
				...
				<td align="right">
					<logic:equal name="novedadRSAdapterVO" property="act" value="aplicar">
						<html:button property="btnAceptar"  styleClass="boton" onclick="submitForm('aplicar', '');">
							<bean:message bundle="rec" key="rec.novedadRSSearchPage.button.aplicar"/>
						</html:button>
					</logic:equal>		
				</td>
 			</tr>
