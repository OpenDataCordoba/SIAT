	...
	<fieldset>
		...
		<table class="tabladatos">
			...
			<tr>
				...
				<td class="normal"><html:textarea name="proCueNoDeuAdapterVO" property="proCueNoDeu.observacion" cols="80" rows="15"/></td>
			</tr>	
		</table>
	</fieldset>	
	<!-- ProCueNoDeu -->
	...
	<table class="tablabotones" width="100%" >
	   	<tr>
   	    	...
   	    	<td align="right" width="50%">
				<logic:equal name="proCueNoDeuAdapterVO" property="act" value="modificar">
					<html:button property="btnAceptar"  styleClass="boton" onclick="submitForm('modificar', '');">
						<bean:message bundle="base" key="abm.button.modificar"/>
					</html:button>
				</logic:equal>
				<logic:equal name="proCueNoDeuAdapterVO" property="act" value="agregar">
