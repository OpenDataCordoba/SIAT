...
<html:form styleId="filter" action="/cyq/AdministrarLiqFormConvenioEsp.do">
	      	...
	      	<tbody>
				...
				<logic:iterate id="LiqCuotaVO" name="liqFormConvenioAdapterVO" property="planSelected.listCuotasForm">
					<tr>
						...
						<td><bean:write name="LiqCuotaVO" property="importeCuota" bundle="base" formatKey="general.format.currency"/>&nbsp;</td>
	...
	<!--  boton Seleccionar Plan -->
		<p align="center">
			...
			<button type="button" name="btnModificarCuotas" class="boton" onclick="submitForm('modificarCuotas', '');">
		  	    <bean:message bundle="cyq" key="cyq.liqFormConvenioAdapter.button.modificarCuotas"/>
			</button>

			<button type="button" name="btnFormConvenio" class="boton" onclick="submitForm('formalizarPlan', '');">		  	    
