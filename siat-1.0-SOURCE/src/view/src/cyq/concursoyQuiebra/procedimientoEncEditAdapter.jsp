...
<!-- Formulario filter -->
<html:form styleId="filter" action="/cyq/AdministrarEncProcedimiento.do">
	...
	<h1><bean:message bundle="cyq" key="cyq.procedimientoEncEditAdapter.title"/></h1>		
	...
	<fieldset>
		...
		<tr>
			...
			<logic:equal name="encProcedimientoAdapterVO" property="act" value="agregar">
				<td class="normal" colspan="3">
					<html:text name="encProcedimientoAdapterVO" property="procedimiento.numeroView" size="5" maxlength="100"/>/ 
					<html:text name="encProcedimientoAdapterVO" property="procedimiento.anioView" size="2" maxlength="4"/>
				</td>
			</logic:equal>
		...
		<tr>
			<td class="normal" colspan="4">
				(**) No es requerida par Transferencia de Fondos de Comercio
			</td>
		</tr>
		<!-- Caratula -->		
		<tr>
		...
		<tr>	
			...
			<td class="normal" colspan="3">
				<html:select name="encProcedimientoAdapterVO" property="procedimiento.juzgado.id" styleClass="select">
