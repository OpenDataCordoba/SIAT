...
public class ItemMenuAdapter extends SweAdapterModel {
	
	private static final long serialVersionUID = 1L;
	
	public static final String NAME = "itemMenuAdapterVO";
	...
	public ItemMenuAdapter(AplicacionVO aplicacionVO){
		this.itemMenu.setAplicacion(aplicacionVO);
	}
	public ItemMenuAdapter(ItemMenuVO itemMenuVO){
		this.itemMenu = itemMenuVO;
	}
	public ItemMenuVO getItemMenu() {
		return itemMenu;
	}
	public void setItemMenu(ItemMenuVO itemMenuVO) {
		this.itemMenu = itemMenuVO;
	}
