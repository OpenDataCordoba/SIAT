...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	   ...
	   <fo:simple-page-master master-name="barcodes-page">
		...
		<!-- Lista de Deudas  -->
					<xsl:if test="EsCuotaSaldo='false'"> 
						...
						<fo:block-container position="absolute" top="54mm" left="0pt"   height="128mm" width="100%" >
                            <fo:block >
							    <!-- Formato Autodeclarativo -->
								<xsl:if test="PoseePeriodoValorCero='true'">
								 <fo:table border-color="black" border-style="solid"  height="130mm" border-width="1.5pt">
											<fo:table-column  />
											    	<fo:table-body>
													    <fo:table-row>
									...
									<fo:table  font-size="10pt" border-color="black">
											...
											<fo:table-column column-width="39mm" />
												<fo:table-body >
													    <fo:table-row>	
																<fo:table-cell border-color="black" border-style="solid" border-width="0.5pt" text-align="center">
																	<fo:block>PERS</fo:block>
																</fo:table-cell>
																<fo:table-cell border-color="black" border-style="solid" border-width="0.5pt" text-align="center">
																	<fo:block>ACTIVIDADES</fo:block>
																</fo:table-cell>
																<fo:table-cell border-color="black" border-style="solid" border-width="0.5pt" text-align="center">
										    ...
										    <fo:table-body>
																<fo:table-row font-family="Courier" >															
																		<fo:table-cell padding="2pt" border-style="solid" border-width="0.5pt">
																				<fo:block>&#160;</fo:block>
																		</fo:table-cell>
																		<fo:table-cell padding="2pt" border-style="solid" border-width="0.5pt">
																				<fo:block>&#160;</fo:block>
										   ...
										   <fo:table-body>
													<fo:table-row font-family="Courier" >															
																        <fo:table-cell padding="2pt" border-style="solid" number-columns-spanned="2" border-width="0.5pt">
																				<fo:block>&#160;</fo:block>
																		</fo:table-cell>
																		<fo:table-cell padding="2pt" border-style="solid" number-columns-spanned="2" border-width="0.5pt">
								    ...
								    <xsl:if test="Recurso/DeclaraAdicionales='true'">
								    <fo:table padding="2mm" font-size="10pt" border-color="black">
											<fo:table-column column-width="51mm" />
										   ...
										   <fo:table-body>
													<fo:table-row font-family="Courier" >															
																        <fo:table-cell padding="2pt" border-style="solid" number-columns-spanned="2" border-width="0.5pt">
																				<fo:block>MENOS RETENCIONES</fo:block>
																		</fo:table-cell>
																		<fo:table-cell padding="2pt" border-style="solid" border-width="0.5pt">
																				<fo:block>&#160;</fo:block>
																		</fo:table-cell>
								      ...
								      <fo:table padding="2mm"  font-size="10pt" border-color="black" text-align="right">
											...
											<fo:table-column column-width="46mm" />
												<fo:table-body >
													    <fo:table-row>
															    <fo:table-cell>
													 			...
													 			<fo:table-cell  border-color="black" border-style="solid" border-width="0.5pt" text-align="center">
																    <fo:block>Vto. Original</fo:block>
																</fo:table-cell>	
																<fo:table-cell border-color="black" border-style="solid" border-width="0.5pt" text-align="center">
																	<fo:block>
																	&#160;<fo:inline>&#160;<xsl:value-of select="FechaVtoOriginalView"/>&#160;</fo:inline>
																	</fo:block>
																</fo:table-cell>
																<fo:table-cell border-color="black" border-style="solid" border-width="0.5pt" text-align="center">
															...
															<xsl:if test="EsReimpresion!='true'">
															<fo:table-row>
																<fo:table-cell>
																	<fo:block>&#160;</fo:block>
																</fo:table-cell>
													 			...
													 			<fo:table-cell  border-color="black" border-style="solid" border-width="0.5pt" text-align="center">
																    <fo:block>Recargo</fo:block>
																</fo:table-cell>	
																<fo:table-cell border-color="black" border-style="solid" border-width="0.5pt" text-align="right">
																	<fo:block>&#160;</fo:block>
																</fo:table-cell>
															</fo:table-row>
															</xsl:if>
												...
												<fo:table-body >
													    <fo:table-row>
																...
																<fo:table-cell border-color="black" border-style="solid" border-width="0.5pt" text-align="center">
																	<fo:block>
																		&#160;<fo:inline>&#160;<xsl:value-of select="FechaVtoView"/>&#160;</fo:inline>
																	</fo:block>
																</fo:table-cell>
																<fo:table-cell border-color="black" border-style="solid" border-width="0.5pt" text-align="center">
																	<fo:block>Total con recargo</fo:block>
																</fo:table-cell>
																<fo:table-cell border-color="black" border-style="solid" border-width="0.5pt" text-align="center">
																	<fo:block>&#160;</fo:block>
																</fo:table-cell>
															...
															<fo:table-row>
																...
																<fo:table-cell>
													 			...
													 			<fo:table-cell  border-color="black" border-style="solid" border-width="0.5pt" text-align="center">
																    <fo:block>Importe Sellado</fo:block>
																</fo:table-cell>	
																<fo:table-cell border-color="black" border-style="solid" border-width="0.5pt" text-align="center">
										...
										<xsl:if test="EsReimpresion!='true'">
										<fo:block text-align="left">Indice de Recargo al <fo:inline>&#160;<xsl:value-of select="FechaVtoView"/>&#160;:</fo:inline><fo:inline>&#160;<xsl:value-of select="ListReciboDeuda/LiqReciboDeudaVO/Actualizacion"/>&#160;</fo:inline>
										</fo:block>
										</xsl:if>
								    </fo:block>
								...
								<!--Fin Formato Autodeclarativo -->
								
								<!-- Formato Original -->
						
								<xsl:if test="PoseePeriodoValorCero='false'">
																...
																<fo:table font-size="8pt"  text-align="center">
																	...
																	<fo:table-header>
													 					<fo:table-row>
																			 ...
																			 <xsl:if test="EsVolPagIntRSView='false'">	
																	...
																	<fo:table-body>
																		<xsl:for-each select="ListReciboDeuda/LiqReciboDeudaVO">
								...
								<xsl:if test="PagaVencido='false'">
									<fo:block font-size="8pt" wrap-option="no-wrap" space-after="2mm" text-align="center">
										<fo:block>
											...
											<xsl:if test="EsVolPagIntRSView='true'">										
												<fo:inline>El banco calcular&#225; el recargo correspondiente a partir de la fecha de pago de capital.</fo:inline>
											</xsl:if>
										</fo:block>
									</fo:block>
								</xsl:if>
	...
	<!-- Vto e Importe Final -->	
								<fo:block font-size="10pt" background-color="#D9D9D9" padding="6pt" border-color="black" border-width="0.5px" border-style="solid">													
										<xsl:if test="EsVolPagIntRSView='false'">	
											...
											<xsl:if test="EsVolPagIntRSView='true'">	
											<fo:inline color="black" font-weight="bold">&#160;Pago de Capital:&#160;</fo:inline>
										</xsl:if>
										<fo:inline color="black" font-family="Courier">
	...
	<!--  Talonarios -->			
							...
							<fo:block-container position="absolute" top="183mm" left="0pt" height="75mm" width="100%" >					
								<fo:block>
														...
														<fo:table>
															...
															<fo:table-body>
																<fo:table-row>
																	...
																	<fo:table-cell text-align="left" font-size="10pt">
																		<fo:block>
																			<xsl:value-of select="Recurso/DesRecurso"/>																		
																		</fo:block>											
																	</fo:table-cell>
														...
														<xsl:if test="PoseePeriodoValorCero='true'">
															<fo:table>
																...
																<fo:table-body>
																	<fo:table-row>
																		<fo:table-cell padding="1pt">
																			<fo:block text-align="left" margin-left="2pt"  font-size="8pt">
																				<fo:inline color="black" text-align="left">Cuenta:&#160;</fo:inline>
																	    		<fo:inline color="black" text-align="left" font-family="Courier">
																	    			<xsl:value-of select="Cuenta/NroCuentaView"/>
																	    		</fo:inline>
																		...
																		<fo:table-cell padding="1pt">
																			...
																			<xsl:if test="NumeroReciboView=000000000">
																				<xsl:choose>
																					<xsl:when test="CodRefPagView!=00000000000">																			
																						<fo:block wrap-option="no-wrap" font-size="8pt">
																							<fo:inline text-align="left">Cod. Ref. Pago:&#160;</fo:inline>
																							<fo:inline text-align="left" font-family="Courier"><xsl:value-of select="CodRefPagView" /></fo:inline>
																						</fo:block>																				
																					</xsl:when>
																	...
																	<fo:table-row>
																		<fo:table-cell padding="1pt">
																			<fo:block text-align="left" margin-left="2pt"  font-size="8pt">
																				<fo:inline color="black" text-align="left">Catastral:&#160;</fo:inline>
																	    		<fo:inline color="black" text-align="left" font-family="Courier">
																	    			<xsl:value-of select="Cuenta/ListAtributoObjImp/LiqAtrValorVO[Key='Catastral']/Value" />
																	    		</fo:inline>
																			</fo:block>  
																		...
																		<fo:table-cell padding="1pt">
																			<fo:block text-align="left" margin-left="2pt"  font-size="8pt">
																				<fo:inline color="black" text-align="left">Convenio Multilateral:&#160;</fo:inline>
																	    		<fo:inline color="black" text-align="left" font-family="Courier">
																		...
																		<fo:table-cell padding="1pt">
																			<fo:block text-align="left" margin-left="2pt"  font-size="8pt">
																				<fo:inline color="black" text-align="left">Cod. Gesti&#243;n:&#160;</fo:inline>
																	    		<fo:inline color="black" text-align="left" font-family="Courier">
																	    			<xsl:value-of select="Cuenta/CodGestionPersonalView"/>
																	    		</fo:inline>
																			</fo:block>  
																	...
																	<fo:table-row>
																		<fo:table-cell padding="1pt">
																			<fo:block text-align="left" margin-left="2pt"  font-size="8pt">
																				<fo:inline color="black" text-align="left">Nro. Ing. Brutos:&#160;</fo:inline>
																	    		<fo:inline color="black" text-align="left" font-family="Courier">
																		...
																		<fo:table-cell padding="1pt">
																			<xsl:if test="NumeroReciboView!=000000000">
																				<fo:block text-align="left" margin-left="2pt"  font-size="8pt" wrap-option="no-wrap">
																					<fo:inline color="black" text-align="left"><xsl:value-of select="TipoDeudaStrLowCase"/>:&#160;</fo:inline>
																	    			<fo:inline color="black" text-align="left" font-family="Courier">
																		...
																		<fo:table-cell>
																			<xsl:if test="CodRefPagView!=00000000000">																			
																					<fo:block wrap-option="no-wrap" font-size="8pt">
																							<fo:inline text-align="left">Cod. Ref. Pago:&#160;</fo:inline>
																							<fo:inline text-align="left" font-family="Courier"><xsl:value-of select="CodRefPagSinCerosView" /></fo:inline>
																					</fo:block>
																			</xsl:if>
																		</fo:table-cell>
																	</fo:table-row>
																 ...
																 <xsl:call-template name="textoDecJur"/>														
															</xsl:if>
    ...
    <!-- Template texto declaracion jurada -->
    
    <xsl:template name="textoDecJur">
    	<fo:block font-size="9pt" text-align="left">
    		<fo:inline color="black" text-align="left">El que suscribe.....................................................DNI........................domiciliado en</fo:inline>
    	</fo:block>
    	<fo:block font-size="9pt" text-align="left">
    		<fo:inline color="black" text-align="left">..................................................en su caracter de.....................................declara bajo</fo:inline>
    	</fo:block>
    	<fo:block font-size="9pt" text-align="left">
    		<fo:inline color="black" text-align="left">juramento que los datos consignados son correctos y completos, y han sido cumplimentados a su legal saber y entender.-</fo:inline>
    	</fo:block>
    	<fo:block font-size="9pt" text-align="center">
    		<fo:inline color="black" text-align="center">[LOCALIDAD],........de..........de...........</fo:inline>
    	</fo:block>
    	<fo:block font-size="9pt" text-align="right">
    		<fo:inline color="black" text-align="right">.................................</fo:inline>
    	</fo:block>
    	<fo:block font-size="9pt" text-align="right">
    		<fo:inline color="black" text-align="right">Sello y firma</fo:inline>
    	</fo:block>
    </xsl:template>
		...
		<fo:table>
			...
			<fo:table-body>				
				...
				<!-- Procurador -->
					<fo:table-cell padding="1pt">
							<fo:block text-align="left" margin-left="2pt">
								<xsl:if test="Procurador/Descripcion!=''">
									<fo:inline color="black" text-align="left">Procurador:&#160;</fo:inline>
								    <fo:inline color="black" text-align="left" font-family="Courier">
								    	<xsl:value-of select="Procurador/Descripcion" />
								    </fo:inline>
								</xsl:if>												
							</fo:block>    
					</fo:table-cell>					
				...
				<fo:table-row>
					...
					<fo:table-cell padding="1pt">
						<fo:block text-align="left" margin-left="2pt">
							<xsl:if test="EsComercio='false'">
								<fo:inline color="black" text-align="left">Ubicaci&#243;n:&#160;</fo:inline>
						    	<fo:inline color="black" text-align="left" font-family="Courier">
						    		<xsl:value-of select="Cuenta/ListAtributoObjImp/LiqAtrValorVO[Key='Ubicacion']/Value" />
						    	</fo:inline>
						    </xsl:if>
						    <xsl:if test="EsComercio='true'">
						    	<fo:inline color="black" text-align="left">Descripci&#243;n de Actividad:&#160;</fo:inline>
						    	<fo:inline color="black" text-align="left" font-family="Courier">
						    		<xsl:value-of select="Cuenta/ListAtributoObjImp/LiqAtrValorVO[Key='DescripActividad']/Value" />
						    	</fo:inline>
						    </xsl:if>
					...
					<fo:table-cell padding="1pt">
						<fo:block text-align="left" margin-left="2pt">
							<fo:inline color="black" text-align="left">Domicilio Env&#237;o:&#160;</fo:inline>
						    <fo:inline color="black" text-align="left" font-family="Courier">
						    	<xsl:value-of select="Cuenta/DesDomEnv" />
						    </fo:inline>
						</fo:block>
				...
				<fo:table-row>
					<fo:table-cell padding="1pt">
						<fo:block text-align="left" margin-left="2pt">
							<fo:inline color="black" text-align="left">Cod. Gesti&#243;n Personal:&#160;</fo:inline>
						    <fo:inline color="black" text-align="left" font-family="Courier">
						    	<xsl:value-of select="Cuenta/CodGestionPersonalView" />
						    </fo:inline>
						</fo:block>
				...
				<!-- Broche -->
					<fo:table-cell padding="1pt">
						<fo:block text-align="left" margin-left="2pt">
							<xsl:if test="IdBroche!=0">
								<fo:inline color="black" text-align="left">Broche:&#160;</fo:inline>
							    <fo:inline color="black" text-align="left" font-family="Courier">
							    	<xsl:value-of select="IdBroche" />
							    </fo:inline>
						   </xsl:if> 
						</fo:block>
					</fo:table-cell>	
			...
			<!--8308: GDE - Gestión de Deuda/Convenios. Gestión por Recurso/Cuenta. Reconfección -->
			<!-- Repartidor -->
			 <fo:table-row>
			 <fo:table-cell padding="1pt">
			 </fo:table-cell>
				<fo:table-cell padding="1pt">
					<fo:block text-align="left" margin-left="2pt">
						<fo:inline color="black" text-align="left">Repartidor:&#160;</fo:inline>
						<fo:inline color="black" text-align="left" font-family="Courier">
							<xsl:value-of select="IdRepartidor" />
						</fo:inline>
					</fo:block>
				</fo:table-cell>
			</fo:table-row>			
 ...
 <!-- Template para datos de la cuenta  Drei-->
    <xsl:template name="datosCuentaDrei">
    	<xsl:param name="LiqReciboVO"/>
	...
	<fo:table>
			...
			<fo:table-body>
				...
				<fo:table-row>
					...
					<fo:table-cell padding="1pt">
						<fo:block text-align="left" margin-right="2pt">
							<fo:inline color="black">Cod. Ges. Personal:&#160;</fo:inline>
							<fo:inline color="black" text-align="left" font-family="Courier">
								<xsl:value-of select="Cuenta/CodGestionPersonalView"/>
							</fo:inline>
						</fo:block>
				...
				<fo:table-row>
					...
					<xsl:if test="EsDeudaRSView='true'">	
						<fo:table-cell padding="1pt">
							<fo:block text-align="left" margin-right="2pt">
								<fo:inline color="black">CUMUR:&#160;</fo:inline>
								<fo:inline color="black" text-align="left" font-family="Courier">
									<xsl:value-of select="Cumur"/>
								</fo:inline>
							</fo:block>
						</fo:table-cell>
					</xsl:if>
    ...
    <!-- FIN Template para datos de la cuenta Drei-->
