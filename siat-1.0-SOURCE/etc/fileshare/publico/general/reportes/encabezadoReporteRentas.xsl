	           			   ...
	           			   <fo:table-column column-width="5cm"/>
				               <fo:table-body>	        
		         			       ...
		         			       <fo:table-row>
						             <fo:table-cell>
		                		        <fo:block text-align="center">
				                		   <fo:inline xsl:use-attribute-sets="inline_title">Direcci&#243;n Balance y Asentamientos</fo:inline>
				    					</fo:block>
			    					   </fo:table-cell>
		                           </fo:table-row>
		                		   <fo:table-row>
						             <fo:table-cell>
		                		        <fo:block text-align="center">
				                		   <fo:inline xsl:use-attribute-sets="inline_title">Dto. Balance de Recaudaci&#243;n</fo:inline>
				    					</fo:block>
		        		             </fo:table-cell>
		                           </fo:table-row>
				   	           </fo:table-body>
